...
def preprocess_train(image, label):
    ...
    image = tf.keras.applications.mobilenet_v2.preprocess_input(image)  # Apply preprocessing
    return image, label

def preprocess_val(image, label):
    image = tf.keras.applications.mobilenet_v2.preprocess_input(image)  # Only preprocessing for validation
    return image, label
